...
# Funkcija za čitanje stanja iz fajla
def ucitaj_stanje():
    try:
        with open('stanje.txt', 'r') as file:
            data = json.load(file)
            return data.get('current_balance', 100000)
    except FileNotFoundError:
        return 100000

# Funkcija za čuvanje stanja u fajl
def sacuvaj_stanje(stanje):
    data = {'current_balance': stanje}
    with open('stanje.txt', 'w') as file:
        json.dump(data, file)

# Učitaj stanje prilikom pokretanja programa
current_balance = ucitaj_stanje()

# Ispisi trenutno stanje
print('Trenutno stanje:', current_balance)



# Sačuvaj novo stanje
sacuvaj_stanje(current_balance)
...
class StartPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        tk.Frame.__init__(self, parent,bg='#66CD00')
        self.controller = controller

        self.controller.title('Bezbednost sigurnost tvoj ATM  --verzija 10.923.4.4--')
        ...
        space_label = tk.Label(self,height=4,bg='#66CD00')
        space_label.pack()

        password_label = tk.Label(self,
                                                      text='Unesite vasu lozinku',
                                                      font=('orbitron',13),
                                                      bg='#66CD00',
                                                      fg='white')
        ...
        def check_password():
           if my_password.get() == '123':
               ...
               incorrect_password_label['text']='Netacna lozinka'
        ...
        bottom_frame = tk.Frame(self,relief='raised',borderwidth=15)
        ...
        time_label = tk.Label(bottom_frame,font=('orbitron',20))
...
class MenuPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        button_frame = tk.Frame(self,bg='#66CD00')
        ...
        deposit_button = tk.Button(button_frame,
                                                            ...
                                                            width=50,
                                                            height=5)
        deposit_button.grid(row=2,column=0,pady=5)
...
class WithdrawPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        choose_amount_label = tk.Label(self,
                                       text='Izaberite kolicinu koju zelite da isplatite',
                                       font=('orbitron', 13),
                                       fg='white',
                                       bg='#66CD00')
        ...
        one_hundred_button = tk.Button(button_frame,
                                                       ...
                                                       width=50,
                                                       height=5)
        one_hundred_button.grid(row=0,column=1,pady=5,padx=120)
...
class BalancePage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        menu_button = tk.Button(button_frame,
                                ...
                                height=3,
                                font=('orbitron', 20))
        menu_button.pack(pady=10, padx=10, fill='both', expand=True)
        ...
        exit_button = tk.Button(button_frame,
                                ...
                                height=3,
                                font=('orbitron', 20))
        exit_button.pack(pady=10, padx=10, fill='both', expand=True)
